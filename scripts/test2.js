...
},{"./stun.json":4,"./turn.json":5,"normalice":3}],3:[function(require,module,exports){
/**
  # normalice
...
},{"./lib/calls":7,"./lib/getpeerdata":8,"cog/extend":11,"mbus":14,"rtc-core/genice":16,"rtc-core/plugin":18,"rtc-pluggable-signaller":19,"rtc-tools":52}],7:[function(require,module,exports){
(function (process){
var rtc = require('rtc-tools');
var debug = rtc.logger('rtc-quickconnect');
...
},{"./getpeerdata":8,"./heartbeat":9,"_process":1,"cog/getable":12,"rtc-tools":52,"rtc-tools/cleanup":48}],8:[function(require,module,exports){
...
},{"detect-browser":17}],16:[function(require,module,exports){
/**
  ### `rtc-core/genice`
...
},{"./detect":15}],19:[function(require,module,exports){
/**
...
},{"rtc-signaller":20,"rtc-switchboard-messenger":39}],20:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"cog/extend":11,"cog/getable":12,"cuid":21,"mbus":14,"pull-pushable":22,"pull-stream":29,"rtc-core/detect":15,"rtc-signal/prepare":36,"rtc-signal/signaller":38}],21:[function(require,module,exports){
/**
 * cuid.js
...
},{"./sinks":26,"./sources":27,"_process":1,"pull-core":25}],29:[function(require,module,exports){
var sources  = require('./sources')
var sinks    = require('./sinks')
var throughs = require('./throughs')
var u        = require('pull-core')
...
},{"./sinks":32,"./sources":33,"_process":1,"pull-core":31}],35:[function(require,module,exports){
var extend = require('cog/extend');
...
},{"cog/extend":11}],36:[function(require,module,exports){
/**
  ### prepare
...
},{"./handlers/announce":35,"cog/jsonparse":13}],38:[function(require,module,exports){
var detect = require('rtc-core/detect');
var extend = require('cog/extend');
var getable = require('cog/getable');
...
},{"./prepare":36,"./process":37,"cog/extend":11,"cog/getable":12,"cuid":21,"mbus":14,"rtc-core/detect":15}],39:[function(require,module,exports){
var extend = require('cog/extend');
...
},{"cog/extend":11,"messenger-ws":40}],40:[function(require,module,exports){
...
},{"cog/defaults":10,"pull-ws":41,"ws":46,"wsurl":47}],41:[function(require,module,exports){
...
},{"./sink":44,"./source":45}],42:[function(require,module,exports){
exports.id = 
function (item) {
  return item
}
...
},{"./ready":43,"_process":1,"pull-core":42}],45:[function(require,module,exports){
var pull = require('pull-core');
var ready = require('./ready');
...
},{"./ready":43,"pull-core":42}],46:[function(require,module,exports){
...
},{"cog/logger":55}],49:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
//     mon.removeAllListeners();
  ...
  function handleCandidate(data, src) {
    ...
    console.error("handleCandidate call: " + JSON.stringify(data))
...
},{"./cleanup":48,"./monitor":53,"cog/logger":55,"cog/throttle":56,"mbus":57,"rtc-taskqueue":61,"whisk/pluck":72}],50:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"rtc-core/detect":58}],51:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"./detect":50,"cog/defaults":54,"cog/logger":55}],52:[function(require,module,exports){
/* jshint node: true */
...
},{"./couple":49,"./detect":50,"./generators":51,"cog/logger":55,"rtc-core/plugin":60}],53:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"mbus":57}],54:[function(require,module,exports){
...
},{"detect-browser":59,"dup":15}],59:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"dup":17}],60:[function(require,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"./detect":58,"dup":18}],61:[function(require,module,exports){
var detect = require('rtc-core/detect');
var findPlugin = require('rtc-core/plugin');
...
},{"mbus":57,"priorityqueuejs":62,"rtc-core/detect":58,"rtc-core/plugin":60,"rtc-sdp":63,"rtc-sdpclean":65,"rtc-validator/candidate":66,"whisk/pluck":72}],62:[function(require,module,exports){
/**
...
},{"./parsers":64,"whisk/flatten":69,"whisk/nub":71,"whisk/pluck":72}],64:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"rtc-validator/candidate":66}],66:[function(require,module,exports){
...
},{"cog/logger":55,"reu/ip":67}],67:[function(require,module,exports){
/**
  ### `reu/ip`
...
},{"./equality":68,"./nub-by":70}],72:[function(require,module,exports){
/**
  ## pluck
...
},{"freeice":2,"rtc-quickconnect":6}]},{},[73]);
